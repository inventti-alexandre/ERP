    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await
                    _userManager.SendEmailAsync(user.Id, "Reset Password",
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    //Eeach User Active Just Main Admin
                    return !user.IsActive ? View("Lockout") : RedirectToLocal(returnUrl);
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Request.Url != null)
                    {
                        var callbackUrl = Url.Action("ConfirmEmail", "Account",
                            new {userId = user.Id, code}, protocol: Request.Url.Scheme);
                        await
                            _userManager.SendEmailAsync(user.Id, "Confirm your account",
        ...
        #endregion Regsitering

        #region Code And Verify
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            var result =
                await
                    _signInManager.TwoFactorSignInAsync(model.Provider, model.Code, isPersistent: false,
