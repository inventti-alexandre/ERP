...
namespace ServiceLayer.Authentication.User.Manager
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        /// </summary>
        IClaimsIdentityFactory<ApplicationUser, Guid> ClaimsIdentityFactory { get; set; }
        ...
        /// </summary>
        IDictionary<string, IUserTokenProvider<ApplicationUser, Guid>> TwoFactorProviders { get; }
        ...
        /// </summary>
        /// <param name="twoFactorProvider" />
        /// <param name="provider" />
        void RegisterTwoFactorProvider(string twoFactorProvider, IUserTokenProvider<ApplicationUser, Guid> provider);
        ...
        Task<bool> IsCompleteMainInfo(Guid userId);
